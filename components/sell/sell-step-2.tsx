  ...
  if (isExpired) {
    return (
      <div className="max-w-[480px] mx-auto text-center py-16">
        ...
        <h1 className="text-2xl font-bold text-[#0D1F3C] mb-2">Deposit Address Expired</h1>
        <p className="text-[#4B5563] mb-2">
          The deposit address for order #{orderData.orderId} has expired.
        </p>
        <p className="text-sm text-amber-700 bg-amber-50 border border-amber-200 rounded-lg p-3 mb-8">
          If you already sent USDT to this address, please contact support immediately with your order ID and transaction hash.
        </p>
        <Button
          onClick={onBack}
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle className="flex items-center gap-2">
              ...
              Have you already sent USDT?
            </AlertDialogTitle>
            <AlertDialogDescription asChild>
              <div className="space-y-2">
                <p>
                  If you have already sent USDT to the deposit address, <strong>do not go back</strong>. Your funds could be lost.
                </p>
                <p>
                  Only go back if you have <strong>not yet sent</strong> any USDT.
                </p>
              </div>
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel>I already sent — stay here</AlertDialogCancel>
            <AlertDialogAction
              onClick={onBack}
              className="bg-red-600 hover:bg-red-700 text-white"
            >
              I haven't sent — go back
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
